...
# Reorganize the weekly data: find all occurrences of locations, 
...
data = read.csv("fe_2017_1_2017_12_east_weekly.csv", header = TRUE)  #Dropping the last couple of days exceeding the 52 weeks
...
write.csv(data, "fe_2017_1_2017_12_east_weekly_filled.csv")
...
eez_east = st_cast(eez_usa_48,"POLYGON")[1,]  #use 2 for west coast
# st_write(eez_usa_48, "eez_usa_48.shp")
# st_write(eez_east, "eez_east.shp")
eez_polygon = as_Spatial(eez_east)
